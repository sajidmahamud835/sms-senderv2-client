...
import './topBar.css'
>>>>>>> 35cc0b63a7e5330417f319cdb63afae4f8179556
import { NotificationsNone, Settings } from "@material-ui/icons";
import { Link, useNavigate } from "react-router-dom";
import Box from '@mui/material/Box';
import Button from '@mui/material/Button';
                ...
                <div className="topRight">
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="NotificationsMenu">
                            ...
                            <li><Link to="/myProfile" className="dropdown-item" type="button">Welcome to our website. Please update your profile to enjoy all our features.</Link></li>
                        </ul>
                    </div>
                    <div onClick={() => navigate("/settings", { replace: true })} className="topbarIconContainer">
                        <Settings />
